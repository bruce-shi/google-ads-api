...
describe('Campaign', () => __awaiter(this, void 0, void 0, function* () {
    describe('reporting', () => __awaiter(this, void 0, void 0, function* () {
        it('can retrieve a list of Campaigns with all fields (if valid)', () => __awaiter(this, void 0, void 0, function* () {
            ...
            if (campaigns.length > 0 && campaigns[0].campaign.resource_name) {
                expect(campaigns[0].campaign).toEqual(expect.objectContaining({
                    resource_name: expect.stringContaining(`customers/${test_utils_1.CID}/campaigns`) || '',
                }));
                const resource = campaigns[0].campaign.resource_name;
                if (resource) {
                    const singleton = yield customer.campaigns.get(resource);
        ...
        it('throws an error when the request is invalid', () => __awaiter(this, void 0, void 0, function* () {
            yield expect(customer.campaigns.list({
                limit: -10,
