...
class AdGroupCriterionLabelService extends service_1.default {
    get(id) {
    ...
    create(ad_group_criterion_label, options) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.serviceCreate(Object.assign({ request: MUTATE_REQUEST, operation: OPERATION_REQUEST, mutate: MUTATE_METHOD, entity: [RESOURCE, ad_group_criterion_label] }, options));
        });
    }
    update(ad_group_criterion_label, options) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.serviceUpdate(Object.assign({ request: MUTATE_REQUEST, operation: OPERATION_REQUEST, mutate: MUTATE_METHOD, entity: [RESOURCE, ad_group_criterion_label] }, options));
        });
    }
    delete(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
...
exports.default = AdGroupCriterionLabelService;
